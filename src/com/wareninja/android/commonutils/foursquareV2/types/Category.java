 ...
 */
public class Category implements FoursquareType, Parcelable, Serializable {
	...
	public String toString() {
		return "Category [mChildCategories=" + mChildCategories
				+ ", mFullPathName=" + mFullPathName + ", mIconUrl=" + mIconUrl
				+ ", mId=" + mId + ", mNodeName=" + mNodeName
				+ ", isPrimary="+isPrimary
				+ "]";
	}
