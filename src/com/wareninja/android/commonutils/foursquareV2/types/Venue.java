 ...
 */
public class Venue implements FoursquareType, Parcelable, Serializable {
    ...
    private Group<Category> mCategories;//YG
    ...
    public void setCategories(Group<Category> categories) {
    	...
    	// check and set primary category
	...
	public String toString() {
		return "Venue [mAddress=" + mAddress 
				+ ", mCategory=" + mCategory
				+ ", mCategories=" + mCategories
				+ ", mCheckins=" + mCheckins + ", mCity=" + mCity
				+ ", mCityid=" + mCityid + ", mCrossstreet=" + mCrossstreet
				+ ", mDistance=" + mDistance + ", mGeolat=" + mGeolat
				+ ", mGeolong=" + mGeolong + ", mHasTodo=" + mHasTodo
				+ ", mId=" + mId + ", mName=" + mName + ", mPhone=" + mPhone
				+ ", mSpecials=" + mSpecials + ", mState=" + mState
				+ ", mStats=" + mStats + ", mTags=" + mTags + ", mTips="
				+ mTips + ", mTodos=" + mTodos + ", mTwitter=" + mTwitter
				+ ", mZip=" + mZip + "]";
	}
